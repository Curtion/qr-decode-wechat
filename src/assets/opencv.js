...
export const cv = (() => {
  ...
  else if (typeof dateNow !== 'undefined') { _emscripten_get_now = dateNow }
  else {
    _emscripten_get_now = function () {
      ...
      audioPlugin.handle = function audioPlugin_handle(
        ...
        if (Browser.hasBlobConstructor) {
          ...
          audio.onerror = function audio_onerror(event) {
            ...
            audio.src = `data:audio/x-${name.substr(-3)};base64,${encode64(
              byteArray,
            )}`
            finish(audio)
          }
    ...
    safeRequestAnimationFrame(func) {
      return Browser.requestAnimationFrame(() => {
        ...
        if (Browser.allowAsyncCallbacks)
          func()
        else Browser.queuedAsyncCallbacks.push(func)
      })
    },
  ...
  function ExceptionInfo(excPtr) {
    ...
    this.release_ref = function () {
      const prev = HEAP32[(this.ptr + ExceptionInfoAttrs.REFCOUNT_OFFSET) >> 2]
        ...
        const constructor = createNamedFunction(legalFunctionName, function () {
          ...
          if (undefined === body) {
            throw new BindingError(
              `Tried to invoke ctor of ${name} with invalid number of parameters (${arguments.length
  ...
  function craftInvokerFunction(
    ...
    return function () {
      ...
      const rv = cppInvokerFunc.apply(null, invokerFuncArgs)
  ...
  function __embind_register_class_class_function(
    ...
    whenDependentTypesAreResolved([], [rawClassType], (classType) => {
      ...
      whenDependentTypesAreResolved([], rawArgTypes, (argTypes) => {
        ...
        const func = craftInvokerFunction(
          humanName,
          invokerArgsArray,
          null,
          rawInvoker,
  ...
  function __embind_register_class_constructor(
    ...
    whenDependentTypesAreResolved([], [rawClassType], (classType) => {
      ...
      if (
        ...
        throw new BindingError(
          `Cannot register multiple constructors with identical number of parameters (${argCount - 1
          }) for class '${classType.name
        ...
        classType.registeredClass.constructor_body[argCount - 1]
          = function constructor_body() {
            if (arguments.length !== argCount - 1) {
              throwBindingError(
                `${humanName} called with ${arguments.length
  ...
  function __emval_get_method_caller(argCount, argTypes) {
    ...
    const argN = Array.from({ length: argCount - 1 })
    const invokerFunction = function (handle, name, destructors, args) {
      let offset = 0
      for (var i = 0; i < argCount - 1; ++i) {
        argN[i] = types[i + 1].readValueFromPointer(args + offset)
        offset += types[i + 1].argPackAdvance
      }
      const rv = handle[name].apply(handle, argN)
      for (var i = 0; i < argCount - 1; ++i) {
    ...
    for (let i = 0; i < array.length; i++) {
      ...
      if (chr > 255) {
        if (ASSERTIONS) {
          assert(
            false,
            `Character code ${chr} (${String.fromCharCode(
              chr,
  ...
  var ___errno_location = (Module.___errno_location = function () {
    return (___errno_location = Module.___errno_location = Module.asm.ba).apply(
      null,
      arguments,
    )
  })
  var ___getTypeName = (Module.___getTypeName = function () {
    return (___getTypeName = Module.___getTypeName = Module.asm.ca).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viijii = (Module.dynCall_viijii = function () {
    return (dynCall_viijii = Module.dynCall_viijii = Module.asm.ea).apply(
      null,
      arguments,
    )
  })
  var dynCall_ji = (Module.dynCall_ji = function () {
    return (dynCall_ji = Module.dynCall_ji = Module.asm.fa).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jiii = (Module.dynCall_jiii = function () {
    return (dynCall_jiii = Module.dynCall_jiii = Module.asm.ha).apply(
      null,
      arguments,
    )
  })
  var dynCall_jii = (Module.dynCall_jii = function () {
    return (dynCall_jii = Module.dynCall_jii = Module.asm.ia).apply(
      null,
      arguments,
    )
  })
  var dynCall_viji = (Module.dynCall_viji = function () {
    return (dynCall_viji = Module.dynCall_viji = Module.asm.ja).apply(
      null,
      arguments,
    )
  })
  var dynCall_jiji = (Module.dynCall_jiji = function () {
    return (dynCall_jiji = Module.dynCall_jiji = Module.asm.ka).apply(
      null,
      arguments,
    )
  })
  var dynCall_iiiiij = (Module.dynCall_iiiiij = function () {
    return (dynCall_iiiiij = Module.dynCall_iiiiij = Module.asm.la).apply(
      null,
      arguments,
    )
  })
  var dynCall_iiiiijj = (Module.dynCall_iiiiijj = function () {
    return (dynCall_iiiiijj = Module.dynCall_iiiiijj = Module.asm.ma).apply(
      null,
      arguments,
    )
  })
  var dynCall_iiiiiijj = (Module.dynCall_iiiiiijj = function () {
    return (dynCall_iiiiiijj = Module.dynCall_iiiiiijj = Module.asm.na).apply(
      null,
      arguments,
    )
  })
  ...
  Module.imread = function (imageSource) {
    ...
    if (img instanceof HTMLImageElement) {
      ...
      throw new TypeError('Please input the valid canvas or img id.')
    }
  ...
  Module.imshow = function (canvasSource, mat) {
    ...
    if (!(canvas instanceof HTMLCanvasElement))
      throw new TypeError('Please input the valid canvas element or id.')

    if (!(mat instanceof cv.Mat))
      throw new TypeError('Please input the valid cv.Mat instance.')
  ...
  Module.VideoCapture = function (videoSource) {
    ...
    if (!(video instanceof HTMLVideoElement))
      throw new TypeError('Please input the valid video element or id.')
